...
CREATE TABLE `collections_app_api_occurrence` (
  ...
  `description` text,
  `model_url` text,
  `django_last_modified` datetime DEFAULT NULL,
  `django_modified_by` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`key`)
