...
class CollectionsAppApiCollectionsrecordset(models.Model):
    recordset_id = models.CharField(primary_key=True, max_length=32)
...
class CollectionsAppApiOccurrence(models.Model):
    ...
    publishing_org = models.ForeignKey('CollectionsAppApiOrganization', models.DO_NOTHING)
    recordsetname = models.ForeignKey(CollectionsAppApiCollectionsrecordset, models.DO_NOTHING, db_column='recordsetName_id')  # Field name made lowercase.
    taxonkey = models.ForeignKey('CollectionsAppApiSpecies', models.DO_NOTHING, db_column='taxonKey_id')  # Field name made lowercase.
